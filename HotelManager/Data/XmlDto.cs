...
{
    [XmlAttribute("RoomNumber")] public string RoomNumber { get; set; }

    [XmlAttribute("RoomType")] public string RoomType { get; set; }
...
public class PersonXml
{
    ...
    [XmlAttribute("RegistrationDate")] public DateTime RegistrationDate { get; set; }

    [XmlElement("LastVisitDate")] public DateTime? LastVisitDate { get; set; }
}

[XmlType("Order")]
public class OrderXml
{
    [XmlAttribute("XmlId")] public string XmlId { get; set; }

    [XmlAttribute("RoomNumber")] public string RoomNumber { get; set; }

    [XmlAttribute("PricePerNight")] public double PricePerNight { get; set; }

    [XmlAttribute("Nights")] public int Nights { get; set; }

    [XmlAttribute("OrderDate")] public DateTime OrderDate { get; set; }

    [XmlAttribute("CheckinDate")] public DateTime CheckinDate { get; set; }

    [XmlAttribute("Status")] public string Status { get; set; }

    [XmlAttribute("Paid")] public bool Paid { get; set; }
}

[XmlType("OrderRole")]
public class OrderRoleXml
{
    [XmlAttribute("OrderXmlId")] public string OrderXmlId { get; set; }

    [XmlAttribute("PersonEmail")] public string PersonEmail { get; set; }
...
public class PaymentXml
{
    ...
    [XmlAttribute("PaymentDate")] public DateTime PaymentDate { get; set; }

    [XmlAttribute("PaymentMethod")] public string PaymentMethod { get; set; }
