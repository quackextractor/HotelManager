...
namespace HotelManager.UI
{
    public partial class DataLoaderForm : Form
    {
        ...
        private void btnLoadConfig_Click(object sender, EventArgs e)
        {
            ...
            {
                string errorMessage = "An error occurred while importing data.\n";
                if (ex.Message.Contains("CK__Order_checkin"))
                {
                    errorMessage += "One or more orders have a check-in date set in the past. Please ensure that all check-in dates are today or in the future.";
                }
